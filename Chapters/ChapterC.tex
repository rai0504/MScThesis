...
In \Cref{sec:interactivepopularweighting} we cover two very popular and widely used graph weighting schemes for general graph cut purposes. We then focus on the proposed weighting system in \Cref{sec:interactiveproposedweighting}. We determine the optimal parameters for all weighting schemes in \Cref{sec:optimalparameters} and present the results in \Cref{sec:interactiveresults}. We present a discussion in \Cref{sec:interactivediscussion} and close the chapter with a conclusion in \Cref{sec:interactive_conclusion}.
...
\begin{definition}[Neighbourhood Interaction Function]
...
\begin{figure}[!t]
	...
	\caption{Plots of mean segmentation accuracy against the corresponding method tuning parameters. \textbf{(a)} Weighting system proposed by Eriksson \textit{et al.} \citep{Eriksson2006}. The remaining parameter is set to $\sigma_R=1$. \textbf{(b)} Weighting system with hard constraints proposed by Boykov \textit{et al.} \citep{Boykov2001_2}. \textbf{(c)} Proposed weighting system without hard constraints. \textbf{(d)} Proposed weighting system with hard constraints.}
...
\begin{figure}[!t]
	...
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleeriksson/1seg}
		\label{fig:eriksson1}
	}
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleboykov/1seg}
		\label{fig:boykov1}
	}
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleproposed/1seg}
		\label{fig:proposed1}
	}
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleproposedHC/1seg}
		\label{fig:proposedhc1}
	}
	
	\caption{Interactive segmentation of Image 1 in sample set (\Cref{fig:sampleset}). \textbf{(a)} Eriksson \textit{et al.} \citep{Eriksson2006}. \textbf{(b)} Boykov \textit{et al.} \citep{Boykov2001_2}. \textbf{(c)} Proposed (No hard constraints) \textbf{(d)} Proposed with hard constraints.}
...
\begin{figure}[!t]
	...
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleboykov/2seg}
		\label{fig:boykov2}
	}
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleproposed/2seg}
		\label{fig:proposed2}
	}
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleproposedHC/2seg}
		\label{fig:proposedhc2}
	}
	
	\caption{Interactive segmentation of Image 2 in sample set (\Cref{fig:sampleset}). \textbf{(a)} Eriksson \textit{et al.} \citep{Eriksson2006}. \textbf{(b)} Boykov \textit{et al.} \citep{Boykov2001_2}. \textbf{(c)} Proposed (No hard constraints) \textbf{(d)} Proposed with hard constraints.}
...
\begin{figure}[!h]
	...
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleeriksson/3seg}
		\label{fig:eriksson3}
	}
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleboykov/3seg}
		\label{fig:boykov3}
	}
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleproposed/3seg}
		\label{fig:proposed3}
	}
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleproposedHC/3seg}
		\label{fig:proposedhc3}
	}
	
	\caption{Interactive segmentation of Image 3 in sample set (\Cref{fig:sampleset}). \textbf{(a)} Eriksson \textit{et al.} \citep{Eriksson2006}. \textbf{(b)} Boykov \textit{et al.} \citep{Boykov2001_2}. \textbf{(c)} Proposed (No hard constraints) \textbf{(d)} Proposed with hard constraints.}
...
\begin{figure}[!h]
	...
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleeriksson/4seg}
		\label{fig:eriksson4}
	}
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleboykov/4seg}
		\label{fig:boykov4}
	}
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleproposed/4seg}
		\label{fig:proposed4}
	}
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleproposedHC/4seg}
		\label{fig:proposedhc4}
	}
	
	\caption{Interactive segmentation of Image 4 in sample set (\Cref{fig:sampleset}). \textbf{(a)} Eriksson \textit{et al.} \citep{Eriksson2006}. \textbf{(b)} Boykov \textit{et al.} \citep{Boykov2001_2}. \textbf{(c)} Proposed (No hard constraints) \textbf{(d)} Proposed with hard constraints.}
...
\begin{figure}[!h]
	...
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleeriksson/5seg}
		\label{fig:eriksson5}
	}
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleboykov/5seg}
		\label{fig:boykov5}
	}
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleproposed/5seg}
		\label{fig:proposed5}
	}
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleproposedHC/5seg}
		\label{fig:proposedhc5}
	}
	
	\caption{Interactive segmentation of Image 5 in sample set (\Cref{fig:sampleset}). \textbf{(a)} Eriksson \textit{et al.} \citep{Eriksson2006}. \textbf{(b)} Boykov \textit{et al.} \citep{Boykov2001_2}. \textbf{(c)} Proposed (No hard constraints) \textbf{(d)} Proposed with hard constraints.}
...
\begin{figure}[!t]
	...
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleeriksson/6seg}
		\label{fig:eriksson6}
	}
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleboykov/6seg}
		\label{fig:boykov6}
	}
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleproposed/6seg}
		\label{fig:proposed6}
	}
	\subfigure[]
	{
		\includegraphics[width=0.23\columnwidth]{/proposedinteractive/sampleproposedHC/6seg}
		\label{fig:proposedhc6}
	}
	
	\caption{Interactive segmentation of Image 6 in sample set (\Cref{fig:sampleset}). \textbf{(a)} Eriksson \textit{et al.} \citep{Eriksson2006}. \textbf{(b)} Boykov \textit{et al.} \citep{Boykov2001_2}. \textbf{(c)} Proposed (No hard constraints) \textbf{(d)} Proposed with hard constraints.}
...
\begin{figure}[!h]
	...
	\subfigure[Eriksson \textit{et al.} \citep{Eriksson2006} $\lambda = 10$, $\sigma_W = 7.5$, $\sigma_R = 1$.]
	{
		\includegraphics[width=0.23\columnwidth]{proposedinteractive/testeriksson/188seg}
		\label{fig:eriksson188}
	}
	\subfigure[Boykov \textit{et al.} \citep{Boykov2001_2} $\lambda=7.5$, $\sigma=5$.]
	{
