...
Computer vision is used heavily in industry, medicine and life science fields included, hence there is a need for a robust, enviromentally resistant approach.
...
To formulate a labelling problem we need a set of \textit{cites}, intuitively known as observations, and a set of \textit{labels}, which is a set of explanations.
...
\begin{table}[ht]
	...
	\begin{tabular}{|c|c|c|c|}
		\hline 
		Image ($\mathcal{P}$) & Number of cites ($|\mathcal{P}|$) & Number of labels ($|\mathcal{L}|$) & Number of configurations $|\mathcal{L}|^{|\mathcal{P}|}$ \\ 
		\hline 
...
The equivalence of MRFs and GRFs, proven by the Hammersely-Clifford thereom, means that maximising \Cref{eq:mrfprobability} is equivalent to minimising \Cref{eq:gibbsenergy} \citep{Winkler2006}:
