...
\begin{definition}[Nonuniform illumination]
	...
	\begin{figure}[!t]
		...
		\subfigure[]
		{
			\includegraphics[width=0.315\columnwidth]{uneven_orig.jpg}
			\label{fig:ImageProcessingOriginal}
		}
		\subfigure[]
		{
			\includegraphics[width=0.315\columnwidth]{uneven.jpg}
			\label{fig:Vignette}
		}
		\subfigure[]
		{
			\includegraphics[width=0.315\columnwidth]{uneven_final.jpg}
...
\begin{definition}[Fading]
	...
	\begin{figure}[!t]
		...
		\subfigure[]
		{
			\includegraphics[width=0.315\columnwidth]{canvas.png}
			\label{fig:ImageProcessingOriginal2}
		}
		\subfigure[]
		{
			\includegraphics[width=0.315\columnwidth]{canvas10.png}
			\label{fig:Photobleach1}
		}
		\subfigure[]
		{
			\includegraphics[width=0.315\columnwidth]{canvas20.png}
...
\begin{figure}[!t]
	...
	\subfigure[]
	{
		\includegraphics[width=0.315\columnwidth]{poisson2.png}
		\label{fig:ImageProcessingOriginal3}
	}
	\subfigure[]
	{
		\includegraphics[width=0.315\columnwidth]{poisson.png}
		\label{fig:PoissonNoise}
	}
	\subfigure[]
	{
		\includegraphics[width=0.315\columnwidth]{poisson_final.png}
