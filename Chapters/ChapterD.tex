...
\begin{definition}[Fading]
	\textcolor{red}{What causes quenching and photobleaching? What techniques are done to reduce it's effect. Why is photobleaching worse?} 
\end{definition}
...
\begin{definition}[Image distortion]
	...
	Image distortion occurs primarily due to two factors: The \textit{point spread function} (PSF) and noise \citep{Sarder2006}.
