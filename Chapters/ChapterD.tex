...
\begin{definition}[Nonuniform illumination]
	...
	\begin{figure}[!t]
		...
		{
			\includegraphics[width=0.3\columnwidth]{placeholder_square.png}
			\label{fig:PoissonCorrupted}
		}
		\caption{\textbf{(a)} Original image. \textbf{(b)} Nonuniformly illuminated image. The Vignette effect. \textbf{(c)} Image corrupted by Poisson noise.}
