...
\begin{figure}[!t]
	...
	\addloflink{http://www.thermofisher.com/us/en/home/life-science/cell-analysis/labeling-chemistry/fluorescence-spectraviewer.html}
...
\begin{figure}[!t]
	...
	\addloflink{www.unlockinglifescode.org/media/images/}
	\addloflink{www.rndsystems.com/resources/ihc-images/53bp1}
...
\Cref{chap:Chapter4} takes a step in this vein.
...
\begin{definition}[Non-uniform illumination]
	...
	\begin{figure}[!t]
		...
		\addloflink{www.cellimagelibrary.org/images/2173}
...
\begin{definition}[Fading]
	...
	It is due to the interaction of the fluorophore with an oxygen molecule.
...
\begin{definition}[Image distortion]
	...
	\begin{equation}
		O = n(s \otimes h),
	\end{equation}
	where $O$ is the formed image, $n$ is the noise function, $s$ is the exact image, $\otimes$ is the convolution operator and $h$ is the specific PSF of the optical system.
...
\begin{definition}[Energy minimisation]
	...
	This technique is widely used in fluorescence image segmentation \citep{Dzyubachyk2008,Ortiz2001,Dufour2005,Dzyubachyk2010,Boukari2014,Maska2007}.
...
\begin{definition}[Shape descriptors]
	...
	The differential chain code (DCC) and boundary chain code (BCC) are the two most commonly used shape descriptors that are used to represent the distance around an object.
