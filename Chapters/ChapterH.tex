...
\chapter{Case-Study: Flourescence Microscopy Cell Segmentation} % Main chapter title

\label{chap:Chapter8} % Change X to a consecutive number; for referencing this chapter elsewhere, use \ref{ChapterX}
