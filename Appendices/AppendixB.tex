...
\begin{figure}[!h]
	...
	\caption{Undirected weighted graph \textbf{H} is a subgraph of \textbf{G} in \Cref{fig:appG}, $\textbf{H} \subseteq \textbf{G}$. Directed weighted graph \textbf{I} is a subgraph of \textbf{D} in Figure \Cref{fig:appD}, $\textbf{I} \subseteq \textbf{D}$. The degree of each node is shown next to the corresponding node. The red box shows the vertex set, the edge set and their corresponding norms.}
\end{figure}
