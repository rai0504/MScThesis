...
\thesistitle{Graph Cut Optimisation} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\department{\href{http://department.university.com}{Department of Electrical, Electronic and Computer Engineering}} % Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
\group{\href{http://researchgroup.university.com}{Computer Vision Research Group}} % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname
...
\include{Chapters/ChapterB} % Mathematical Backgrounds
\include{Chapters/ChapterC} % Interactive Segmentation on 1D Data
\include{Chapters/ChapterD} % Interactive Segmentation on Multi-Dimensional Data
% Texture Segmentation
\include{Chapters/ChapterE} % Automatic Graph Cut Segmentation
...
\include{Chapters/ChapterH} % Case Study: Fluorescence Microscopy Cell Segmentation
